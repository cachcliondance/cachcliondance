...
const Footer = () => {
  return (
    <div className="footer text-center p-4">
      <h1>
        COLORADO ASIAN CULTURAL HERITAGE CENTER DRAGON AND LION DANCE
        ASSOCIATION
      </h1>
      <div className="container">
        <div className="row align-items-center justify-content-center">
          <div className="col-sm-4 col-5">
            <p>Phong Vo</p>
            <a className="navbar-link" href="mailto:pvo15@yahoo.com">
              <p>pvo15@yahoo.com</p>
            </a>
            <p>303-669-1095</p>
            <div className="social-logos">
              ...
              <a href="https://www.instagram.com/cachc.liondance/">
                <svg
